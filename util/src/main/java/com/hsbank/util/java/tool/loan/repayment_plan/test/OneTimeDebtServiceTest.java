 ...
 * 2015-07-27
 */
public class OneTimeDebtServiceTest {
	public static void main(String[] args) {
		...
		//生成还款计划
		List<RepaymentPlanItem> repaymentPlan = RepaymentPlanFactory.getInstance(LoanConstant.REPAYMNET_METHOD_ONE_TIME).generate(totalLoan, totalMonth, annualInterestRate, discount, strBeginDate);
		...
		System.out.println("累计应还利息 = " + RepaymentPlanFactory.getInstance(LoanConstant.REPAYMNET_METHOD_ONE_TIME).calculate(totalLoan, totalMonth, annualInterestRate, discount));
	}
}
