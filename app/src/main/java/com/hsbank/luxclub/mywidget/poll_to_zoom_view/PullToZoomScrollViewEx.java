package com.hsbank.luxclub.mywidget.poll_to_zoom_view;
 ...
 * 下拉头布局放大自定义控件，适用于scrollview
 * 源代码地址：https://github.com/Frank-Zhu/PullZoomView
 */
...
//                Log.i("***CLC***", "InternalScrollView-->" + "onScrollChanged: "+"---"+l+"---"+t+"---"+oldl+"---"+oldt);
            }
        }
    }
