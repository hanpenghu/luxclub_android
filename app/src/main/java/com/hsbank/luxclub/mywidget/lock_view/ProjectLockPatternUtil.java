...
public class ProjectLockPatternUtil {
    ...
    public ProjectLockPatternUtil(Context context) {
    ...
    public static void saveLockPattern(List<LockPatternView.Cell> pattern) {
        // Compute the hash
        final byte[] hash = ProjectLockPatternUtil.patternToHash(pattern);
        try {
    ...
    public boolean checkPattern(List<LockPatternView.Cell> pattern) {
        try {
            ...
            return Arrays.equals(stored,
                    com.hsbank.luxclub.mywidget.lock_view.ProjectLockPatternUtil.patternToHash(pattern));
        } catch (FileNotFoundException fnfe) {
            return true;
        } catch (IOException ioe) {
            return true;
