...
/**
 * 高仿IOSswitchbutton，支持滑动悬停和动画
 * 源代码地址：https://github.com/iielse/SwitchButton
 */
...
public class SwitchView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? 0xffFFB900 : 0xffe3e3e3);
        ...
        paint.setColor(isOn ? 0xffFFB900 : 0xffbfbfbf);
        canvas.drawPath(bPath, paint);
