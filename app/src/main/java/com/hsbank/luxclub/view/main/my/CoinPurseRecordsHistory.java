 ...
 */
public class CoinPurseRecordsHistory extends ProjectBaseActivity {
    /**页容量*/
    ...
    protected int getLayoutId() {
        return R.layout.activity_coin_purse_records_history;
    }
    ...
    public void onEventMainThread(BaseProjectEvent event) {
        ...
        if(event.getCommand().equals(MyEvent.COMMAND_MY_RECORDS_HISTORY)){
    ...
    protected void viewHandler() {
        setToolbarTitle(R.string.txt_consumption);
    ...
    private AdapterView.OnItemClickListener listItemClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> adapterView, View view,
            ...
            OrderDetailActivity.show(mContext, MapUtil.getString(dataItem, "orderId"),MapUtil.getInt(dataItem, "orderState"));
        }
    };
    ...
    private ApiCallback feeRecordCallback = new ApiCallback() {
        ...
        public void onResponse(ApiResponseBean response) {
            if (response.getCode() == ApiCodeConstant.SUCCESS_CODE) {
                EventBus.getDefault().post(new MyEvent(MyEvent.COMMAND_MY_RECORDS_HISTORY, response.getData()));
            } else {
                AlertUtil.getInstance().alertMessage(CoinPurseRecordsHistory.this, response.getText());
            }
        }
    };
    ...
    public static void show(Context context) {
        ...
        intent.setClass(context, CoinPurseRecordsHistory.class);
