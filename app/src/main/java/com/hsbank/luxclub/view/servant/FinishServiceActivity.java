...
public class FinishServiceActivity extends ProjectBaseActivity implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_finish_service;
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setToolbarTitle("确认完成服务");
                ...
                .setItems(array, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            ...
                            case 1:
                                // 相册选取
                                MediaUtil.takeAlbum(ImageUtil.CHOOSE_BIG_PICTURE, FinishServiceActivity.this);
                                break;
                        }
                    }
                }).show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_cancel:
                AlertUtil.getInstance().alertMessage(mContext, "上传总结取消");
                finish();
                break;
        }
    }
    ...
    public static void show(Context context, String orderId) {
        ...
        intent.setClass(context, FinishServiceActivity.class);
