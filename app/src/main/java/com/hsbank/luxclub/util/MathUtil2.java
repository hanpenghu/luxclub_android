...
public class MathUtil2 {
	 ...
	 * @return 		v1 大于v2
	 */
	public static boolean isMax(double v1, double v2) {
	 ...
	 * @return 		v1 大于v2
	 */
	public static boolean isMax(String v1, String v2) {
	 ...
	 * @return 		v1 小于v2
	 */
	public static boolean isMin(double v1, double v2) {
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
		BigDecimal b2 = new BigDecimal(Double.toString(v2));
		return b1.compareTo(b2) == -1;
	}
	 ...
	 * @return 		v1 小于v2
	 */
	public static boolean isMin(String v1, String v2) {
		v1 = TextUtils.isEmpty(v1) ? "0" : v1;
		v2 = TextUtils.isEmpty(v2) ? "0" : v2;
		BigDecimal b1 = new BigDecimal(v1);
		BigDecimal b2 = new BigDecimal(v2);
