 ...
 */
public class MyRecordsHistoryAdapter extends BaseAdapter {
    ...
    public MyRecordsHistoryAdapter(FragmentActivity fragmentActivity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = fragmentActivity.getLayoutInflater().inflate(
                    R.layout.layout_my_records_consumption_item, parent, false);
        ...
        for(int i=0;i<dataList.size();i++){
           if(dataList.get(i).get(date)!=null){
               BigDecimal priceBigDecimal = new BigDecimal(dataList.get(i).get(date));
               String dateValueStr = String.format("%1$,.2f",
                       priceBigDecimal.doubleValue());
               holder.mTxtMoneySum.setText(fragmentActivity.getString(R.string.txt_record_consumption) + String.valueOf(dateValueStr));
               break;
           }
        }
        ...
        holder.mTxtSiteName.setText(MapUtil.getString(dataItemCurrent, "siteName"));
        holder.mTxtOrderCode.setText(fragmentActivity.getString(R.string.txt_order_number)+MapUtil.getString(dataItemCurrent, "orderCode"));
