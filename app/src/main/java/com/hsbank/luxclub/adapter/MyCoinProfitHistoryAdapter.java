 ...
 */
public class MyCoinProfitHistoryAdapter extends BaseAdapter {
    ...
    public MyCoinProfitHistoryAdapter(FragmentActivity fragmentActivity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        for(int i=0;i<dataList.size();i++){
           if(dataList.get(i).get(date)!=null){
               ...
               holder.mTxtMoneySum.setText(fragmentActivity.getString(R.string.txt_feeMoney) + "+" + String.valueOf(dateValueStr));
               break;
           }
        }
        ...
        holder.mTxtSiteName.setText(fragmentActivity.getString(R.string.txt_profit_history));
