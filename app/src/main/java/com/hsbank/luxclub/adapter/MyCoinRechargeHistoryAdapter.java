 ...
 */
public class MyCoinRechargeHistoryAdapter extends BaseAdapter {
    ...
    public MyCoinRechargeHistoryAdapter(FragmentActivity fragmentActivity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.mTxtSiteName.setText(fragmentActivity.getString(R.string.txt_coin_purse_card));
